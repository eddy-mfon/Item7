      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-14 sm:mb-20">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-4xl sm:text-5xl md:text-6xl font-display font-black text-gray-950 mb-6 tracking-tighter"
          >
        ...
        <div className="grid md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 relative">
          ...
          {steps.map((step, idx) => {
            ...
            <motion.div
              ...
              className="relative bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-300 border border-gray-100 group flex flex-col items-center text-center"
            >
              ...
              <h3 className="text-xl sm:text-2xl font-black font-display text-gray-950 mb-4 tracking-tight group-hover:text-brand transition-colors">{step.title}</h3>
              <p className="text-gray-500 font-medium leading-relaxed text-base sm:text-[17px]">
                {step.desc}
              </p>
            </motion.div>
          )})}
